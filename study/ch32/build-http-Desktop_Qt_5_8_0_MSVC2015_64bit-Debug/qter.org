...
<html>
  ...
  <body>
    ...
    <div id="frame">
      ...
      <strong class="short-error">Lantern could not access the server at .</strong>
      ...
      <ul>
        ...
        <li>
          Does the error message <code>Unable to round-trip http request to upstream: http: no Host in request URL��</code> mean something to you?
        </li>
      </ul>
    </div>
